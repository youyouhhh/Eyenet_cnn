...
def main():
    ...
    md = model.EyeNet()
    md.load_state_dict(torch.load(r"C:\Users\youyou\Desktop\课程\智慧医疗\EyeNet-A-Convolutional-Neural-Network-for-Glaucomatous-Fundus-Lesion-Detection-main\EyeNet-A-Convolutional-Neural-Network-for-Glaucomatous-Fundus-Lesion-Detection-main\best_model.pth"))
